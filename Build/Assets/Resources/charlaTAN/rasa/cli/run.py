...
def run(args: argparse.Namespace, receiver_id: Optional[str] = "") -> None:
    ...
    if args.enable_api:
        ...
        rasa.run(**vars(args), receiver_id=receiver_id)
        return
    ...
    model_path = os.path.join(DEFAULT_CHATBOTS_PATH, receiver_id, DEFAULT_MODELS_PATH) if receiver_id != "" else args.model
    args.model = _validate_model_path(model_path, "model", DEFAULT_MODELS_PATH)
