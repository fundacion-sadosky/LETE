...
class UserMessage:
    ...
    def __str__(self) -> str:
        return f"text: {self.text}, message_id: {self.message_id}, sender_id: {self.message_id} "
...
def register(
    ...
    async def handler(message: UserMessage, receiver_id="") -> None:
        from CharlatanAccess import charlatan_manager
        if(receiver_id != ""):
            await charlatan_manager.get_agent(receiver_id).handle_message(message)
        else:
